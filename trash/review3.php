...
if (isset($_GET['product_id'])) {
    ...
    $response = makeRequest($API_URL_PRODUCT . $productId . '?populate=*', $token, 'GET');
...
<body>
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-3 text-center rating_con">
        ...
        <button type="button" name="add_review" id="add_review" class="btn btn-primary form-control mt-3"
