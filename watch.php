...
$queryParams[] = 'filters[categories][$eq]=' . urlencode('watch');
...
.smartphones_products-container {
    ...
    /* spațiu între produsele de pe rând */
}
...
<div class="smartphones_viewport_container">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapsePriceRange" class="accordion-collapse collapse show"
                        ...
                        <div class="accordion-body">
                            ...
                            <input type="range" id="priceMinRange" name="price_min" min="0" max="5000" step="50"
                                value="<?php echo isset($_GET['price_min']) ? $_GET['price_min'] : '500'; ?>"
                                oninput="updatePriceRange()">
                            <span
                                id="minPriceOutput"><?php echo isset($_GET['price_min']) ? $_GET['price_min'] : '500'; ?>
                                Lei</span>
                            <br>

                            <label for="priceMax">Preț maxim:</label>
                            <input type="range" id="priceMaxRange" name="price_max" min="0" max="5000" step="50"
                                value="<?php echo isset($_GET['price_max']) ? $_GET['price_max'] : '3500'; ?>"
                                oninput="updatePriceRange()">
                            <span
                                id="maxPriceOutput"><?php echo isset($_GET['price_max']) ? $_GET['price_max'] : '3500'; ?>
                                Lei</span>
                        </div>
                    </div>
                </div>
    ...
    <div class="smartphones_products-container">
        ...
        <div class="smartphones_product-item">
            ...
            <a href="watch_product.php?id=<?php echo $product['id']; ?>" class="smartphones_add-to-cart">Buy Now</a>
        </div>
        <?php endforeach; ?>
    </div>
</div>
...
function updatePriceRange() {
    var priceMin = document.getElementById('priceMinRange').value;
    var priceMax = document.getElementById('priceMaxRange').value;

    // Asigură-te că prețul minim nu depășește prețul maxim și invers
    if (parseInt(priceMin) > parseInt(priceMax)) {
        document.getElementById('priceMinRange').value = priceMax;
        priceMin = priceMax;
    }

    document.getElementById('minPriceOutput').innerText = priceMin + ' Lei';
    document.getElementById('maxPriceOutput').innerText = priceMax + ' Lei';
}
